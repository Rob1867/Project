...
data_source = context.data_sources.add_or_update_pandas_filesystem(
    name="data_source", base_directory=".."
)
...
suite = context.suites.add_or_update(gx.ExpectationSuite(name="sales_data_suite"))

# TODO: Add more expectations
suite.add_expectation(gxe.ExpectColumnValuesToBeUnique(column="Script Activity ID"))
#suite.add_expectation(gxe.ExpectColumnValuesToNotBeNull(column="price_per_unit"))
